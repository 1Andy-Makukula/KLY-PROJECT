...
class SenderCatalog extends StatefulWidget {
  const SenderCatalog({super.key});

  @override
  State<SenderCatalog> createState() => _SenderCatalogState();
}

class _SenderCatalogState extends State<SenderCatalog> {
