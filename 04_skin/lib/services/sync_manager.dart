...
class KithlySyncManager {
  static KithlySyncManager? _instance;
  ...
  static KithlySyncManager get instance {
    _instance ??= KithlySyncManager._();
    return _instance!;
  }
  ...
  Future<bool> _attemptUpload(PendingUpload item) async {
    try {
      ...
      if (item.imagePath != null) {
        ...
        request.files.add(await http.MultipartFile.fromPath('photo', item.imagePath!));
      ...
      if (response.statusCode >= 200 && response.statusCode < 300) {
        ...
        if (body['zra_result_code'] == '000' || body['zra_result_code'] == '001') {
          return true;
        }
